...
var _makeMap = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./modules/makeMap\""); e.code = 'MODULE_NOT_FOUND';; throw e; }()));
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/v1/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        ...
        searchResults.innerHTML = _dompurify2.default.sanitize('<div class= \'search__result\'> No store with ' + _this.value + ' found.</div>');
      }

      searchResults.innerHTML = _dompurify2.default.sanitize('<div class= \'search__result\'> Loading...</div>');
    }).catch(function (err) {
      console.error(err);
    });
  });

  // handle keyboard option
